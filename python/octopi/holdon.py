...
#     b = color_utils.remap(random_values[(ii+6)%n_pixels], 0, 1, 0.2, 1)
    ...
    if random_values[ii] < 0.5:
        #r, g, b = (1, 0.3, 0.8) #pink, cyan, white
        r, g, b = (1.8, 0.5, 0.2) #oranges 
    ...
    twinkle_speed = 0.1
    twinkle_density = 30
    twinkle = (random_values[ii]*7 + time.time()*twinkle_speed) % 2
    ...
    twinkle **= 5
    twinkle *= color_utils.cos(t - ii/n_pixels, offset=0, period=7, minn=0.1, maxx=1.0) ** 0.05
